...
public class CustomerController {
	...
	public ResponseEntity<CustomerResponseDto> addCustomers(CustomerRequestDto customer) throws BalanceNotEmptyExcpetion, MinimumBalanceException {
	...
	public ResponseEntity<TransactionResponseDto> fundTransfor(TransactionRequestDto transactionrequest) throws InsufficientFundsException, ParseException {
	 ...
	 * 
	 * @param empty 
	 * @return ResponseEntity of list of transactions for accountId  
	 * @throws InsufficientFundsException when from account balance empty or less than to account 
	 */
